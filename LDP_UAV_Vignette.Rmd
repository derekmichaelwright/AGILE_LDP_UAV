---
title: "Disecting lentil crop growth in contrasting environments using digital imaging and and genome-wide association studies"
...
> - `r shiny::icon("newspaper")` [Derek M. Wright, Sandesh Neupane, Steve Shirtliffe, Tania Gioia, Giuseppina Logozzo, Stefania Marzario, Karsten M.E. Neilson & Kirstin E. Bett. **Disecting lentil crop growth in contrasting environments using digital imaging and and genome-wide association studies**. *unpublished*.](https://github.com/derekmichaelwright/AGILE_LDP_UAV) 
> - `r shiny::icon("github")` https://github.com/derekmichaelwright/AGILE_LDP_UAV

which is follow-up to:

> - `r shiny::icon("newspaper")` [Sandesh Neupane, Derek Wright, Raul Martinez, Jakob Butler, Jim Weller, Kirstin Bett. **Focusing the GWAS *Lens* on days to flower using latent variable phenotypes derived from global multi-environment trials**. *The Plant Genome*. (**2022**) 16(1): e20269. doi.org/10.1002/tpg2.20269](https://doi.org/10.1002/tpg2.20269) 
...
> - `r shiny::icon("chart-line")` [Additional/Supplemental_Figure_06_Su17.html](https://derekmichaelwright.github.io/AGILE_LDP_UAV/Additional/Supplemental_Figure_06_Su17.html)

> - `r shiny::icon("chart-line")` [Additional/Supplemental_Figure_06_It17.html](https://derekmichaelwright.github.io/AGILE_LDP_UAV/Additional/Supplemental_Figure_06_It17.html)
